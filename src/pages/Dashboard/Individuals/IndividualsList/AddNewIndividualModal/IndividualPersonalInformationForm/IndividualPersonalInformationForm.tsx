...
export default function IndividualPersonalInformationForm() {
    ...
    const [maritalStatusModel, setMaritalStatusModel] = useState<DropDownFormData>({
    ...
    const [codeAlertsModel, setCodeAlertsModel] = useState<MultiSelectDropDownFormData>({
        label: 'Code alerts',
            ...
            <div className={styles.form_content}>
                <div className={styles.row}>
                    ...
                    <InputField 
                        ...
                        onInput={(inputValue:string) => setInput(inputValue, middlenameModel, setMiddlenameModel)}
                    />
                ...
                <div className={styles.row}>
                    ...
                    <DropDownField 
                        ...
                        onSelect={(optionIndex:number)=> selectOption(optionIndex, genderModel, setGenderModel)}
                    />
                </div>
                ...
                <div className={styles.row}>
                    <DropDownField 
                        ...
                        onSelect={(optionIndex:number)=> selectOption(optionIndex, maritalStatusModel, setMaritalStatusModel)}
                    />
                    ...
                    <InputField 
                        ...
                        onInput={(inputValue:string) => setInput(inputValue, religionModel, setReligionModel)}
                    />
                    ...
                    <InputField 
                        ...
                        onInput={(inputValue:string) => setInput(inputValue, ssnModel, setssnModel)}
                    />
                </div>
                ...
                <div className={styles.row}>
                    <InputField 
                        ...
                        onInput={(inputValue:string) => setInput(inputValue, medicaidModel, setMedicaidModel)}
                    />
                    ...
                    <MultiSelectDropDownField
                        ...
                        label={""} 
                        onSelect={(selectedValues:Array<string>)=> setCodeAlertsModel(state => ({...state, value: selectedValues}))}
                    />
                    ...
                    <InputField 
                        ...
                        onInput={(inputValue:string) => setInput(inputValue, weightModel, setWeightModel)}
                    />
                </div>
                
                <div className={styles.row_header}>Contact information (a guardian or relative)</div>
                <div className={styles.row}>
                    <InputField 
                        ...
                        onInput={(inputValue:string) => setInput(inputValue, contactFullnameModel, setContactFullnameModel)}
                    />
                    ...
                    <InputField 
                        ...
                        onInput={(inputValue:string) => setInput(inputValue, contactEmailAddressModel, setContactEmailAddressModel)}
                    />
