...
import { RadioButtonFormFieldType, SetRadioButtonFormFieldType } from "src/components/FormComponents/RadioButtonField/types"
...
export default function QuestionCard({
    question, answer, comment, position, optionSelectAction, commentAction
}:QuestionCardProps) {
    ...
    useEffect(()=> {
        setAnswerOptions(state => ({
            ...state,
            selectedIndex: answerOptions.options.findIndex(option => option.value === answer),
            ...
            <div className={styles.question_content}>
                ...
                <div>
                    <RadioButtonField
                        ...
                        selectOption={(optionIndex:number)=> selectAnswer(optionIndex, answerOptions, setAnswerOptions)}/>
                </div>
                <div className={styles.comment}>
                    <TextField
                        ...
                        onInput={(value:string)=> setInput(value, commentModel, setCommentModel)}
                    />
                </div>
            </div>
        </div>
