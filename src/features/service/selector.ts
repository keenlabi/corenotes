...
// const fetchServiceMedicationsListSelector = selectorFamily({
//     key: 'fetch_service_medications_list_selector',
//     get: (pageNumber:number)=> async ()=> {
//         return await fetchServiceMedicationsListAction(pageNumber)
//         .then((response)=> {
//             return {
...
//     }
// })
// export const useFetchServiceMedicationsListSelector = (pageNumber:number)=> useRecoilValue(fetchServiceMedicationsListSelector(pageNumber))